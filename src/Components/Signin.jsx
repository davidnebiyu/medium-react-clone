...
function Signin() {    
  ...
  const validateValidity = (e = null) => {
    ...
    if (e) {
      ...
      dispatchForm({
        type: "validity",
        name: "pass",
        value: !isEmpty(formValues.values.pass),
      });
    }
  };
  ...
  const submitForm = async () => {
    ...
    try {
      const signinUser = await signinEmail({
        ...
        {!emailsignin ? (
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="mt-[2rem]">
              ...
              <button
                onClick={() => {
                  dispatch(uiAction.setModalElement(Signup));
                }}
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            >
              <div className="">
                ...
                />
                {formValues.hasSubmit && formValues.validity.email == false && (
              ...
              <div className="">
                ...
                {formValues.hasSubmit && formValues.validity.pass == false && (
                  <p className="text-red-500">Password Can not be Empty!</p>
                )}
              </div>
            ...
            >
              {" "}
              <FaAngleLeft className="text-xl" /> All sign in options
            </button>
            <p className="text-center text-xs">
              Click “Sign In” to agree to Medium’s Terms of Service and
              acknowledge that Medium’s Privacy Policy applies to you.{" "}
