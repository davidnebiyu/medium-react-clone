          ...
          <>
            {type == "modal-content" ? (
                 ...
                 {createPortal( 
                  <div className={``}>
                    <div
                      ...
                      } fixed top-0 left-0 bg-[#fffffff2] shadow-lg border p-8 pt-16 z-[600] w-full h-[100vh] overflow-y-auto`}
                    >
                      <button
                        onClick={()=>{onClose()}}
              ...
              <>
                <Backdrop
                  onClick={handleClose}
                  transparent={type == "sidebar" ? true : "semi"}
                />
                {children}
              </>
            )}
          ...
          {createPortal(
            <div className={``}>
              ...
              <div
                className={`transition-all duration-1000 ${
                  isOpen ? "visible opacity-100" : "invisible opacity-0"
                } fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-white shadow-lg border p-8  z-[600] w-[80%] max-w-[600px]`}
              >
                <button
                  onClick={handleClose}
                  className="absolute right-1 top-1 p-2 text-xl"
